...
import HomePageAnimation from '../../config/animation/HomePageAnimation.jsx';
function Home() {
        ...
        <>
            <div className="homeContainer">
                <div className = "leftColumn">
                    ...
                    <HomePageAnimation className="box personalDetails transition" delay={0.1} direction="left">
                        <h1> ✏️ Personal details </h1>
                        <div className="details">
                            <p> ⏰ Bro has lived: {timeLived?.toLocaleString()} second </p>
                            <p> 💪 Gender: {profile.gender} </p>
                            <p> 🚩 Country: {profile.country} </p>
                            <p> 💕 Status: {profile.relationshipStatus} </p>
                        </div>
                    </HomePageAnimation>
                    <HomePageAnimation className="box work transition" delay={0.25} direction="left">
                        <h1> 💼 Work </h1>
                        <div className="details">
                    ...
                    <HomePageAnimation className="box education transition" delay={0.4} direction="left">
                        <h1> Education </h1>
                        {
                ...
                <HomePageAnimation className="box main" delay={0.55} direction="left">
                    ...
                    <div>
                        ...
                        <div style = {{ display: "flex", flexDirection: "row" }}>
                            <div className = "image-wrapper">
                                <img className = "image" src = "/image/page/home/mark-zuckerberg.jpg" alt="Mark Zuckerberg" style={{transform: "rotate(-4deg)"}}/>
                                <div className="pin"></div>
                            </div>
                            <div className = "image-wrapper">
                                <img className = "image" src = "/image/page/home/markxoan.jpg" alt="Mark Zuckerberg" style={{transform: "rotate(-4deg)"}}/>
                                <div className="pin"></div>
                            </div>
                        </div>
