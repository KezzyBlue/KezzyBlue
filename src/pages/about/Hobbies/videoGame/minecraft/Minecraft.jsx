    ...
    return (<>
        <div className="minecraftContainer">
            ...
            <div className="minecraftUserInfo">
                ...
                <div className = "uuid"> 
                    <h1 className = "sectionLabel"> UUID </h1>
                    <p style = {{color: "var(--text0)", fontWeight: "bold"}}> {user.uuid} </p>
                </div>

                <div className = "skinUrl">
                    <h1 className = "sectionLabel"> Skin </h1>
                ...
                <h1 className = "sectionLabel"> Owned </h1>
